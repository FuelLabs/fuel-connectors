...
import '../index.css';
import { setAppConfig } from '@fuel-connectors/shared';
import { defaultConnectors } from '@fuels/connectors';
import { FuelProvider } from '@fuels/react';
import * as Toast from '@radix-ui/react-toast';
import ScreenSizeIndicator from '@shared/screensize-indicator';
...
const config = {
  ...
  counterContractId: 'contract-id',
  chainIdName: 'testnet',
  defaultAmount: bn.parseUnits('0.0001'), // Adjust based on your needs
};
