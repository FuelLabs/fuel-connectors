...
export const bytecodeArray: BytesLike = new Uint8Array([
...
class PredicateInstantiator {
  ...
  async run(): Promise<void> {
    ...
    console.log(
      `   ABI Functions: ${predicateData.abi.functions?.length || 0}`,
    );
    console.log(
